...
class HiraganaKatakanaDictionaries:
    ...
    def __init__(self):
        self.hiragana_dictionary = hiragana_dictionary = dict(あ="A", い="I", う="U", え="E", お="O", か="KA", き="KI", く="KU", け="KE", こ="KO", が="GA", ぎ="GI",
        ...
        self.katakana_dictionary = katakana_dictionary = dict(ア="A", イ="I", ウ="U", エ="E", オ="O", カ="KA", キ="KI", ク="KU", ケ="KE", コ="KO", ガ="GA", ギ="GI",
